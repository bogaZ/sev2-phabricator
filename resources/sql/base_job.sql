...
CREATE TABLE IF NOT EXISTS `{$WORKSPACE}_job_notification` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `postingPHID` varbinary(64) NOT NULL,
  `utcInitialEpoch` int(10) unsigned NOT NULL,
  `targetPHID` varbinary(64) NOT NULL,
  `didNotifyEpoch` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `key_notify` (`postingPHID`,`utcInitialEpoch`,`targetPHID`)
) ;



CREATE TABLE IF NOT EXISTS `{$WORKSPACE}_job_posting` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `salaryCurrency` varchar(32) COLLATE utf8mb4_bin NOT NULL DEFAULT 'IDR',
  `salaryFrom` int(10) unsigned DEFAULT NULL,
  `salaryTo` int(10) unsigned DEFAULT NULL,
  `benefit` longtext COLLATE utf8mb4_bin,
  `perk` longtext COLLATE utf8mb4_bin,
  `targetHiring` int(10) unsigned DEFAULT '0',
  `utcInitialEpoch` int(10) unsigned NOT NULL,
  ...
  `business` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL,
  `stack` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `{$WORKSPACE}_job_posting_fdocument` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `{$WORKSPACE}_job_posting_ffield` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `{$WORKSPACE}_job_posting_fngrams` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `documentID` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `{$WORKSPACE}_job_posting_fngrams_common` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `ngram` char(3) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `{$WORKSPACE}_job_postingapplicant` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `postingPHID` varbinary(64) NOT NULL,
  `applicantPHID` varbinary(64) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `key_posting` (`postingPHID`,`applicantPHID`),
  KEY `key_applicant` (`applicantPHID`)
) ;



CREATE TABLE IF NOT EXISTS `{$WORKSPACE}_job_postingtechstack` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `postingPHID` varbinary(64) NOT NULL,
  ...
  `dateModified` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `key_path` (`postingPHID`,`coursepathItemPHID`)
) ;



CREATE TABLE IF NOT EXISTS `{$WORKSPACE}_job_postingtransaction` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `phid` varbinary(64) NOT NULL,
  `authorPHID` varbinary(64) NOT NULL,
  `objectPHID` varbinary(64) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `{$WORKSPACE}_job_postingtransaction_comment` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `phid` varbinary(64) NOT NULL,
