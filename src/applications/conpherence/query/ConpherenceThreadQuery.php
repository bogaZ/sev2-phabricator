...
final class ConpherenceThreadQuery
  ...
  public function withPilotHQ($hq = false) {
    $this->isHQ = $hq;
    return $this;
  }

  public function withPublic($is_public = false) {
    $this->isPublic = $is_public;
    return $this;
  }

  public function withIsDeleted($is_deleted = true) {
  ...
  public function withTagsPHIDs(array $tags_phids) {
    $this->tagsPHIDs = $tags_phids;
    return $this;
  }
  ...
  protected function buildWhereClauseParts(AphrontDatabaseConnection $conn) {
    ...
    if ($this->tagsPHIDs !== null) {
        $where[] = qsprintf(
          $conn,
          'thread.tagsPHID IN (%Ls)',
          $this->tagsPHIDs);
    }
    ...
    if ($this->isDeleted !== null) {
      $deleted_int = (int)$this->isDeleted;
      $where[] = qsprintf(
        $conn,
        'thread.isDeleted = %d',
        $deleted_int);
