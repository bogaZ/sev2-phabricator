...
final class PhabricatorRepositorySchemaSpec
  ...
  public function buildSchemata() {
    ...
    $this->buildRawSchema(
      ...
      sev2table(PhabricatorRepository::TABLE_COVERAGE),
      array(
        'id' => 'auto',
        'branchID' => 'id',
        'commitID' => 'id',
    ...
    $this->buildRawSchema(
      id(new PhabricatorRepository())->getApplicationName(),
      sev2table(PhabricatorRepository::TABLE_FILESYSTEM),
      array(
        'repositoryID' => 'id',
        'parentID' => 'id',
        'svnCommit' => 'uint32',
    ...
    $this->buildRawSchema(
      id(new PhabricatorRepository())->getApplicationName(),
      sev2table(PhabricatorRepository::TABLE_LINTMESSAGE),
      array(
        'id' => 'auto',
        'branchID' => 'id',
        'path' => 'text',
    ...
    $this->buildRawSchema(
      id(new PhabricatorRepository())->getApplicationName(),
      sev2table(PhabricatorRepository::TABLE_PARENTS),
      array(
        'id' => 'auto',
        'childCommitID' => 'id',
        'parentCommitID' => 'id',
    ...
    $this->buildRawSchema(
      id(new PhabricatorRepository())->getApplicationName(),
      sev2table(PhabricatorRepository::TABLE_PATH),
      array(
        'id' => 'auto',
        'path' => 'text',
        'pathHash' => 'bytes32',
    ...
    $this->buildRawSchema(
      id(new PhabricatorRepository())->getApplicationName(),
      sev2table(PhabricatorRepository::TABLE_PATHCHANGE),
      array(
        'repositoryID' => 'id',
        'pathID' => 'id',
        'commitID' => 'id',
    ...
    $this->buildRawSchema(
      id(new PhabricatorRepository())->getApplicationName(),
      sev2table(PhabricatorRepository::TABLE_SUMMARY),
      array(
        'repositoryID' => 'id',
        'size' => 'uint32',
        'lastCommitID' => 'id',
