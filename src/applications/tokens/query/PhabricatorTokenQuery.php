...
final class PhabricatorTokenQuery
  ...
  private function getBuiltinTokens() {
    $specs = array(
      ...
      array('extra-1', pht('Cool')),
      array('extra-2', pht('Handshake')),
      array('extra-3', pht('LoL')),
      array('extra-4', pht('Noted')),
      array('extra-5', pht('OK')),
      array('extra-6', pht('Get better soon')),
      array('extra-7', pht('Well noted')),
      array('extra-8', pht('Acknowledge of inevitable event')),
      array('extra-9', pht('Thanks!')),
      array('extra-10', pht('Cheers!')),
      array('extra-11', pht('Sip!')),
      array('extra-12', pht('Refactory Quality')),
    );
