...
final class PhabricatorProjectColumnPosition extends PhabricatorProjectDAO
  ...
  private $maniphests = self::ATTACHABLE;
  ...
  public function getManiphests() {
    return $this->assertAttached($this->maniphests);
  }

  public function attachManiphests(array $maniphests) {
    assert_instances_of($maniphests, 'ManiphestTask');
    $this->maniphests = $maniphests;
    return $this;
  }
