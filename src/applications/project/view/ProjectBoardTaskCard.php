...
final class ProjectBoardTaskCard extends Phobject {
  ...
  public function setSubOwner(PhabricatorObjectHandle $sub_owner = null) {
    $this->subOwner = $sub_owner;
    return $this;
  }
  ...
  public function getItem() {
    ...
    if ($sub_owner) {
      $card->addHandleIcon($sub_owner, $sub_owner->getName());
    }
    ...
    $card->addAttribute($progress_tag);
