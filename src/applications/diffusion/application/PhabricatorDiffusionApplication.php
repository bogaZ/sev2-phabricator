    ...
    $repository_routes = array(
      '/' => array(
        ...
        'edit/' => array(
          ...
          'buildinfo/' => 'DiffusionRepositoryBuildInfoController',
          'buildinfo/(?P<build_id>[1-9]\d*)/file/' => array(
            '(query/(?P<queryKey>[^/]+)/)?'
              => 'DiffusionRepositoryBuildInfoFileListController',
            'upload/' => 'DiffusionRepositoryBuildInfoUploadFileController',
            'delete/' => 'DiffusionRepositoryBuildInfoFileRemoveController',
          ),
          'nomad_profile/' => 'DiffusionRepositoryNomadProfileController',
          'nomad_job/' => 'DiffusionRepositoryNomadJobController',
        ),
