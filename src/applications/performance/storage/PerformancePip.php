...
final class PerformancePip
  ...
  public static function addNewTarget(
    ...
    $pip = self::initializeNewEntry($actor, $target, $content_source);
    ...
    $editor = id(new PerformancePipEditor())
      ->setActor($actor)
    ...
    $unguarded = AphrontWriteGuard::beginScopedUnguardedWrites();
      ...
      $editor->applyTransactions($pip, $xactions);
  ...
  public function getApplicationTransactionEditor() {
    return new PerformancePipEditor();
  }

  public function getApplicationTransactionTemplate() {
    return new PerformancePipTransaction();
  }
