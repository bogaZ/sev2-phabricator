...
abstract class LobbyStateDateLastTalkTransaction
  extends JobPostingTransactionType {

  const TRANSACTIONTYPE = 'lobby:state-datelasttalk';

  public function generateOldValue($object) {
    $editor = $this->getEditor();

    return $object->newDateLastTalkForEdit()
      ->newAbsoluteDateTime()
      ->toDictionary();
  }
  ...
  public function applyInternalEffects($object, $value) {
    ...
    $object->setDateLastTalkTime($datetime);
  }
