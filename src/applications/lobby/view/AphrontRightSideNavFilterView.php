 ...
 *
 */
final class AphrontRightSideNavFilterView extends AphrontView {
  ...
  private function renderFlexNav() {
    ...
    if ($this->menu->getItems()) {
      ...
      $local_menu = phutil_tag(
        'div',
        array(
          'class' => 'phabricator-nav-local phabricator-side-menu phabricator-side-right',
          'id' => $local_id,
        ),
