  ...
  protected function buildCustomEditFields($object) {
    ...
    $fields = array(
      ...
      id(new PhabricatorBoolEditField())
        ...
        ->setAsCheckbox(true)
        ->setTransactionType(
          PhabricatorCalendarEventIsForDevTransaction::TRANSACTIONTYPE)
        ->setDescription(pht('Marks this as development testing.'))
        ->setConduitDescription(pht('Make this event for development testing.'))
        ->setConduitTypeDescription(
            pht('Make this event for development testing .'))
    ...
    $conpherence_type = PhabricatorCalendarEventHasConpherenceEdgeType::EDGECONST;
