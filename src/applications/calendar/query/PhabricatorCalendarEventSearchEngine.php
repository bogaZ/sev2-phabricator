...
final class PhabricatorCalendarEventSearchEngine
  ...
  protected function buildCustomSearchFields() {
    return array(
      ...
      id(new PhabricatorSearchIntField())
        ->setLabel(pht('Occurs After (conduit)'))
        ->setKey('rangeDateAfter')
        ->setAliases(array('rangeDateAfter')),
      id(new PhabricatorSearchIntField())
        ->setLabel(pht('Occurs Before (conduit)'))
        ->setKey('rangeDateBefore')
        ->setAliases(array('rangeDateBefore')),
      ...
      id(new PhabricatorSearchThreeStateField())
        ...
        ->setDescription(
          pht(
            'Pass true to find event only for '.
            'Development events.')),
  ...
  protected function buildQueryFromParameters(array $map) {
    ...
    if ($map['rangeDateAfter'] || $map['rangeDateBefore']) {
      $range_start = (int) $map['rangeDateAfter'];
      $range_end = (int) $map['rangeDateBefore'];
