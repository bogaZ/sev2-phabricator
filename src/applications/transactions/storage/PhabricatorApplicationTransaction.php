...
abstract class PhabricatorApplicationTransaction
  ...
  public function setTransactionCheckIn($checkin_datetime) {
    return $this->setMetadataValue('user.checkin', $checkin_datetime);
  }

  public function getTransactionCheckIn() {
    return $this->getMetadataValue('user.checkin', null);
  }
