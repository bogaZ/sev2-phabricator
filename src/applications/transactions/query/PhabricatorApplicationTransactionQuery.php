...
abstract class PhabricatorApplicationTransactionQuery
  ...
  public function withTransactionType($with_transaction_type) {
    $this->withTransactionType = $with_transaction_type;
    return $this;
  }
  ...
  protected function buildWhereClauseParts(AphrontDatabaseConnection $conn) {
    ...
    if ($this->withTransactionType !== null) {
      $where[] = qsprintf(
        $conn,
        'x.transactionType = %s',
        $this->withTransactionType);
    }
