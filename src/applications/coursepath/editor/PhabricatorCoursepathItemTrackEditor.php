...
final class PhabricatorCoursepathItemTrackEditor
  ...
  public function getEditorObjectsDescription() {
    return pht('Item Track');
  }

  public function getCreateObjectTitle($author, $object) {
    return pht('%s created this track.', $author);
  }
  ...
  public function getMailTagsMap() {
    return array(
      CoursepathTransaction::MAILTAG_DETAILS =>
        pht('Someone changes the track\'s details.'),
      CoursepathTransaction::MAILTAG_COMMENT =>
        pht('Someone comments on a track.'),
      CoursepathTransaction::MAILTAG_OTHER =>
        pht('Other track activity not listed above occurs.'),
    );
  }
  ...
  protected function buildMailTemplate(PhabricatorLiskDAO $object) {
    $name = $object->getName();
    $id = $object->getID();
    $subject = pht('Item Track %d: %s', $id, $name);
