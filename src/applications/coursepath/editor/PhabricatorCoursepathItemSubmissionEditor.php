...
final class PhabricatorCoursepathItemSubmissionEditor
  ...
  public function getCreateObjectTitle($author, $object) {
    return pht('%s submitted this submission.', $author);
  }

  public function getCreateObjectTitleForFeed($author, $object) {
    return pht('%s submitted %s.', $author, $object);
  }
  ...
  public function getMailTagsMap() {
    return array(
      CoursepathTransaction::MAILTAG_DETAILS =>
        pht('Someone changes submission\'s details.'),
      CoursepathTransaction::MAILTAG_COMMENT =>
        pht('Someone comments on a submission.'),
      CoursepathTransaction::MAILTAG_OTHER =>
        pht('Other submission activity not listed above occurs.'),
    );
  }
  ...
  protected function buildMailTemplate(PhabricatorLiskDAO $object) {
    $name = $object->getName();
    $id = $object->getID();
    $subject = pht('Skill submission %d: %s', $id, $name);
