...
final class CelerityDarkModePostprocessor
  ...
  public function buildVariables() {
    return array(
      ...
      'lightgreybackground' => '#1f2329',
      'greybackground'      => '#858a93',
      'darkgreybackground'  => '#8C98B8',

      // Base Blues
      'thinblueborder'      => '#858a93',
      'lightblueborder'     => '#858a93',
      'blueborder'          => '#8C98B8',
      ...
      // Buttons
      'blue.button.color' => '#fb9600',
      'blue.button.gradient' => 'linear-gradient(to bottom, #faad3c, #fb9600)',
      'blue.button.hover' => 'linear-gradient(to bottom, #faad3c, #fa9f19)',
      'green.button.color' => '#139543',
      'green.button.gradient' => 'linear-gradient(to bottom, #23BB5B, #139543)',
      'grey.button.color' => '#1f2329',
      'grey.button.gradient' => 'linear-gradient(to bottom, #1f2329, #1f2329)',
      'grey.button.hover' => 'linear-gradient(to bottom, #191c21, #191c21)',
