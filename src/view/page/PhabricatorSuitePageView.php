 ...
 * basic styles.
 */
final class PhabricatorSuitePageView extends PhabricatorBarePageView
  ...
  protected function willRenderPage() {
    ...
    require_celerity_resource('refactory-suite-css');
    if ($this->splash) {
      require_celerity_resource('font-raleway');
      require_celerity_resource('refactory-suite-splash-css');
    }
  ...
  protected function getBody() {
    ...
    $main_page = phutil_tag(
      'div',
      array(
        'id' => 'phabricator-suite-page',
        'class' => 'phabricator-suite-page',
      ),
      array(
        $developer_warning,
        $header_chrome,
