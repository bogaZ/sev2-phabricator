...
final class PHUIBadgeView extends AphrontTagView {
  ...
  public function setImageOwnerPHID($phid) {
    $this->imageOwnerPHID = $phid;
    return $this;
  }

  public function setIconOwner($icon) {
    $this->iconOwner = $icon;
    return $this;
  }
  ...
  protected function getTagContent() {
    if ($this->image && $this->imageOwnerPHID && $this->iconOwner) {
      $illustration = phutil_tag(
        'div',
        array(
        'id' => 'phui-badge-owner-'.$this->imageOwnerPHID,
        'class' => 'phui-badge-illustration phui-badge-owner',
        'style' => 'background-image: url('.$this->image.'); '.
          'background-size:cover;'
        ), phutil_tag(
          'span',
          array(
            'id' => 'phui-badge-owner-indicator-'.$this->imageOwnerPHID,
            'class' => 'phui-icon-inside-badge phui-font-fa '.$this->iconOwner,
          )
        ));
    } else {
