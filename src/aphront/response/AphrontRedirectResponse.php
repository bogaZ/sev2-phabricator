...
class AphrontRedirectResponse extends AphrontResponse {
  ...
  public function setIsSuite($suite) {
    $this->isSuiteProtocol = $suite;
    return $this;
  }
  ...
  public function getURI() {
    ...
    return self::getURIForRedirect($this->uri, $this->isExternal, $this->isSuiteProtocol);
  }
  ...
  public function getHeaders() {
    $headers = array();
    if (!$this->shouldStopForDebugging()) {
      $uri = self::getURIForRedirect($this->uri, $this->isExternal, $this->isSuiteProtocol);
   ...
   */
  public static function getURIForRedirect($uri, $is_external, $is_suite_protocol = false) {
    $uri_object = new PhutilURI($uri);
    if ($is_external) {
      if (!$is_suite_protocol) {
