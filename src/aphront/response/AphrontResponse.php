...
/* -(  Metadata  )----------------------------------------------------------- */
  ...
  private function newContentSecurityPolicyHeader() {
    ...
    // @TODO : Fix default-src / img-src for alternate domain
    ...
    // @TODO : find a way to keep emit this security header without interfere suite registration
    // $csp[] = $this->newContentSecurityPolicy('form-action', "'none'");
